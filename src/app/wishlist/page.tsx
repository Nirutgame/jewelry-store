    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-8">
        ...
        <p className="text-gray-500">
          สินค้าที่คุณบันทึกไว้ {items.length > 0 && `(${items.length} รายการ)`}
        </p>
      </div>
      ...
      {items.length === 0 ? (
        <div className="text-center py-20">
          ...
          <p className="text-gray-500 mb-8">
            กดถูกใจสินค้าที่คุณชื่นชอบเพื่อเก็บไว้ดูภายหลัง
          </p>
          ...
          {items.map((item) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <Link href={`/products/${item.product.id}`}>
                  <h3 className="font-serif font-bold text-gray-800 mb-2 hover:text-gold-700 transition-colors line-clamp-1">
                    {item.product.name}
                  </h3>
                </Link>
                <p className="text-lg font-bold text-gold-700 mb-3">
