  ...
  return (
    <>
      ...
      <div className="mb-6">
        <Link
          href="/products"
          className="text-gray-500 hover:text-gold-700 flex items-center gap-1 text-sm"
        >
      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-3xl font-bold text-gold-700 mb-6">
          ...
          <div className="space-y-3 mb-8">
            <div className="flex items-center gap-2">
              <span className="text-sm text-gray-500 w-20">วัสดุ:</span>
              <span className="font-medium text-gray-800">{product.material}</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-sm text-gray-500 w-20">คงเหลือ:</span>
      ...
      <div className="mt-16 border-t pt-12">
        ...
        {session && (
          <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
            ...
            <div className="mb-4">
              <p className="text-sm text-gray-500 mb-2">ให้คะแนน</p>
        ...
        {reviews.length === 0 ? (
          <p className="text-gray-400 text-center py-12">ยังไม่มีรีวิว</p>
        ) : (
              ...
              <div key={review.id} className="bg-white rounded-xl shadow-sm p-6">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-800">{review.user.name || "ผู้ใช้"}</p>
